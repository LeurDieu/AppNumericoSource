...
class T_C(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="TRAZADORES CUADRATICOS", font=("controller.title_font",30),width="60",height="0",fg="cyan2")
        label.pack()
