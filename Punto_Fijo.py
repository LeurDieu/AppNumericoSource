...
class P_F(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="PUNTO FIJO", font=("controller.title_font",30),width="60",height="0",fg="cyan2")
        label.pack()
        ...
        #a:
        label =tk.Label(self,text="g(x) : ",fg="gray25", font=("Comic Seans MS",15),width="10",height="2")
        label.place(x=250, y=50)
        at=tk.Entry(self, textvariable=self.entradaG)
    ...
    def calcular(self):
        ...
        var2=str(self.entradaG.get())
        var3=float(self.entradaX.get())
        var4=float(self.entradaT.get())
        var5=float(self.entradaN.get())
        
        self.s=puntofijo(self.f,var2,var3,var4,var5)
