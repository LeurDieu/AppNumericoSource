...
class CHO(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="CHOLESKY", font=("controller.title_font",30),width="60",height="0",fg="cyan2")
        label.pack()
    ...
    def calcular(self):
        ...
        self.t.pack(side=tk.BOTTOM,padx=380, pady=20, expand= True,fill=tk.BOTH)
